...
- ### Nessus Basic Network Scan(환경 : Metasploitable2-Linux)
  ...
  #### 이번 점검을 통해 새로운 정보들을 확인할 수 있었으나(AJP, 배너 관리 등), 주요 통신기반 취약점 검사 리스트의 항목들을 모두 탐지하려면 Nessus Professional의 Compliance 기능을 사용하여 .audit 파일을 생성하고 커스텀 점검을 수행해야 했습니다. 그로 인해 완벽한 점검은 이루어지지 않았지만, 
